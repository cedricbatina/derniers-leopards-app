...
onMounted(() => {
  ...
  els.forEach((el, idx) => { el.style.setProperty('--reveal-delay', `${Math.min(idx * 55, 320)}ms`); io.observe(el) })
})
        ...
        <div class="flex flex-col gap-4 sm:gap-5">
          ...
          <div class="flex flex-wrap gap-2 pt-1">
            <NuxtLink :to="localePath('/scenes')" class="btn btn-primary focus-ring">
              <Icon name="mdi:movie-open-outline" aria-hidden="true" />
    ...
    <div class="grid gap-4 lg:grid-cols-3">
      <div class="card card-hover card-accent accent-earth js-reveal">
        <div class="card-body space-y-2">
          <div class="badge badge-accent w-fit">
            ...
            {{ t('explore.scenesPage.pillars.card.badge') }}
          </div>
          <div class="font-extrabold text-lg title-gradient">{{ t('explore.scenesPage.pillars.card.title') }}</div>
          <p class="text-sm text-muted">{{ t('explore.scenesPage.pillars.card.desc') }}</p>
        </div>
      </div>
      ...
      <div class="card card-hover card-accent accent-river js-reveal">
        <div class="card-body space-y-2">
          <div class="badge badge-accent w-fit">
            ...
            {{ t('explore.scenesPage.pillars.links.badge') }}
          </div>
          <div class="font-extrabold text-lg title-gradient">{{ t('explore.scenesPage.pillars.links.title') }}</div>
          <p class="text-sm text-muted">{{ t('explore.scenesPage.pillars.links.desc') }}</p>
        </div>
      </div>
      ...
      <div class="card card-hover card-accent accent-copper js-reveal">
        <div class="card-body space-y-2">
          ...
          <div class="font-extrabold text-lg title-gradient">{{ t('explore.scenesPage.pillars.versions.title') }}</div>
          <p class="text-sm text-muted">{{ t('explore.scenesPage.pillars.versions.desc') }}</p>
        </div>
      </div>
    </div>
      ...
      <div class="card-body">
        ...
        <div class="grid gap-3 sm:grid-cols-3 mt-4">
          ...
          <div class="card card-hover bg-surface2 card-accent accent-copper js-reveal">
            <div class="card-body space-y-2">
              <div class="badge badge-accent w-fit">
                <Icon name="mdi:file-export-outline" aria-hidden="true" />
