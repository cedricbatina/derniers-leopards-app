import { d as defineEventHandler, e as createError, z as getProjectByOwnerSlug, a as dbQuery, r as readBody } from '../../../../../nitro/nitro.mjs';
import 'node:crypto';
import 'nodemailer';
...
const _bookSlug__put = defineEventHandler(async (event) => {
  ...
  const existing = rows == null ? void 0 : rows[0];
  if (!existing) throw createError({ statusCode: 404, statusMessage: "Not found" });
  const body = await readBody(event);
  if ((body == null ? void 0 : body.slug) && String(body.slug).trim() && String(body.slug).trim() !== bookSlug) {
...
export { _bookSlug__put as default };
//# sourceMappingURL=_bookSlug_.put.mjs.map
