...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    useSeoMeta(() => ({
      title: t("pages.scenes.meta.title", { name: t("app.name") }),
      description: t("pages.scenes.meta.description"),
      ogTitle: t("pages.scenes.meta.ogTitle", { name: t("app.name") }),
      ogDescription: t("pages.scenes.meta.ogDescription")
    }));
    return (_ctx, _push, _parent, _attrs) => {
      const _component_NuxtLink = __nuxt_component_0;
      const _component_Icon = __nuxt_component_2;
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "space-y-6" }, _attrs))}><header class="space-y-2"><h1 class="text-2xl font-extrabold tracking-tight">${ssrInterpolate(unref(t)("pages.scenes.title"))}</h1><p class="text-muted">${ssrInterpolate(unref(t)("pages.scenes.subtitle"))}</p></header><div class="card"><div class="card-body space-y-3"><p class="text-sm text-muted">${ssrInterpolate(unref(t)("pages.comingSoon"))}</p><div class="flex flex-wrap gap-2">`);
...
//# sourceMappingURL=index-BJoVP5ft.mjs.map
