...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "space-y-6 sm:space-y-10" }, _attrs))} data-v-2a776d99><div class="card card-hover card-accent accent-river overflow-hidden js-reveal" data-v-2a776d99><div class="card-body" data-v-2a776d99><div class="flex flex-col gap-4 sm:gap-5" data-v-2a776d99><p class="badge badge-accent w-fit" data-v-2a776d99>`);
      _push(ssrRenderComponent(_component_Icon, {
        name: "mdi:timeline",
        "aria-hidden": "true"
      }, null, _parent));
      _push(` ${ssrInterpolate(unref(t)("explore.timelinePage.hero.badge"))}</p><h1 class="text-3xl sm:text-5xl font-extrabold tracking-tight title-gradient title-underline" data-v-2a776d99>${ssrInterpolate(unref(t)("explore.timelinePage.hero.title"))}</h1><p class="text-subtle max-w-2xl" data-v-2a776d99>${ssrInterpolate(unref(t)("explore.timelinePage.hero.lead"))}</p><div class="flex flex-wrap gap-2 pt-1" data-v-2a776d99>`);
      ...
      _push(`</div></div></div></div><div class="grid gap-4 lg:grid-cols-3" data-v-2a776d99>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="card card-hover card-accent accent-earth bg-surface2 h-full" data-v-2a776d99${_scopeId}><div class="card-body space-y-2" data-v-2a776d99${_scopeId}><div class="badge badge-accent w-fit" data-v-2a776d99${_scopeId}>`);
            _push2(ssrRenderComponent(_component_Icon, {
              name: "mdi:calendar-clock-outline",
              "aria-hidden": "true"
            }, null, _parent2, _scopeId));
            _push2(` ${ssrInterpolate(unref(t)("explore.timelinePage.pillars.events.badge"))}</div><div class="font-extrabold text-lg title-gradient" data-v-2a776d99${_scopeId}>${ssrInterpolate(unref(t)("explore.timelinePage.pillars.events.title"))}</div><p class="text-sm text-muted" data-v-2a776d99${_scopeId}>${ssrInterpolate(unref(t)("explore.timelinePage.pillars.events.desc"))}</p></div></div>`);
          } else {
            return [
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="card card-hover card-accent accent-forest bg-surface2 h-full" data-v-2a776d99${_scopeId}><div class="card-body space-y-2" data-v-2a776d99${_scopeId}><div class="badge badge-accent w-fit" data-v-2a776d99${_scopeId}>`);
            _push2(ssrRenderComponent(_component_Icon, {
              name: "mdi:map-marker-path",
              "aria-hidden": "true"
            }, null, _parent2, _scopeId));
            _push2(` ${ssrInterpolate(unref(t)("explore.timelinePage.pillars.arcs.badge"))}</div><div class="font-extrabold text-lg title-gradient" data-v-2a776d99${_scopeId}>${ssrInterpolate(unref(t)("explore.timelinePage.pillars.arcs.title"))}</div><p class="text-sm text-muted" data-v-2a776d99${_scopeId}>${ssrInterpolate(unref(t)("explore.timelinePage.pillars.arcs.desc"))}</p></div></div>`);
          } else {
            return [
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="card card-hover card-accent accent-copper bg-surface2 h-full" data-v-2a776d99${_scopeId}><div class="card-body space-y-2" data-v-2a776d99${_scopeId}><div class="badge badge-accent w-fit" data-v-2a776d99${_scopeId}>`);
            _push2(ssrRenderComponent(_component_Icon, {
              name: "mdi:source-branch",
              "aria-hidden": "true"
            }, null, _parent2, _scopeId));
            _push2(` ${ssrInterpolate(unref(t)("explore.timelinePage.pillars.versions.badge"))}</div><div class="font-extrabold text-lg title-gradient" data-v-2a776d99${_scopeId}>${ssrInterpolate(unref(t)("explore.timelinePage.pillars.versions.title"))}</div><p class="text-sm text-muted" data-v-2a776d99${_scopeId}>${ssrInterpolate(unref(t)("explore.timelinePage.pillars.versions.desc"))}</p></div></div>`);
          } else {
            return [
      ...
      _push(`</div><div class="card js-reveal" data-v-2a776d99><div class="card-body" data-v-2a776d99><div class="flex items-center justify-between gap-3" data-v-2a776d99><div data-v-2a776d99><div class="font-extrabold text-lg title-gradient" data-v-2a776d99>${ssrInterpolate(unref(t)("explore.timelinePage.practice.title"))}</div><div class="text-sm text-muted" data-v-2a776d99>${ssrInterpolate(unref(t)("explore.timelinePage.practice.subtitle"))}</div></div><div class="badge" data-v-2a776d99>`);
      _push(ssrRenderComponent(_component_Icon, {
        name: "mdi:toolbox-outline",
        "aria-hidden": "true"
      }, null, _parent));
      _push(` ${ssrInterpolate(unref(t)("explore.timelinePage.practice.badge"))}</div></div><div class="grid gap-3 sm:grid-cols-3 mt-4" data-v-2a776d99>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="card card-hover bg-surface2 card-accent accent-earth h-full" data-v-2a776d99${_scopeId}><div class="card-body space-y-2" data-v-2a776d99${_scopeId}><div class="badge badge-accent w-fit" data-v-2a776d99${_scopeId}>`);
            _push2(ssrRenderComponent(_component_Icon, {
              name: "mdi:flag-outline",
              "aria-hidden": "true"
            }, null, _parent2, _scopeId));
            _push2(` ${ssrInterpolate(unref(t)("explore.timelinePage.practice.one.badge"))}</div><div class="font-extrabold title-gradient" data-v-2a776d99${_scopeId}>${ssrInterpolate(unref(t)("explore.timelinePage.practice.one.title"))}</div><p class="text-sm text-muted" data-v-2a776d99${_scopeId}>${ssrInterpolate(unref(t)("explore.timelinePage.practice.one.desc"))}</p></div></div>`);
          } else {
            return [
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="card card-hover bg-surface2 card-accent accent-river h-full" data-v-2a776d99${_scopeId}><div class="card-body space-y-2" data-v-2a776d99${_scopeId}><div class="badge badge-accent w-fit" data-v-2a776d99${_scopeId}>`);
            _push2(ssrRenderComponent(_component_Icon, {
              name: "mdi:link-variant",
              "aria-hidden": "true"
            }, null, _parent2, _scopeId));
            _push2(` ${ssrInterpolate(unref(t)("explore.timelinePage.practice.two.badge"))}</div><div class="font-extrabold title-gradient" data-v-2a776d99${_scopeId}>${ssrInterpolate(unref(t)("explore.timelinePage.practice.two.title"))}</div><p class="text-sm text-muted" data-v-2a776d99${_scopeId}>${ssrInterpolate(unref(t)("explore.timelinePage.practice.two.desc"))}</p></div></div>`);
          } else {
            return [
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="card card-hover bg-surface2 card-accent accent-copper h-full" data-v-2a776d99${_scopeId}><div class="card-body space-y-2" data-v-2a776d99${_scopeId}><div class="badge badge-accent w-fit" data-v-2a776d99${_scopeId}>`);
            _push2(ssrRenderComponent(_component_Icon, {
              name: "mdi:check-circle-outline",
              "aria-hidden": "true"
            }, null, _parent2, _scopeId));
            _push2(` ${ssrInterpolate(unref(t)("explore.timelinePage.practice.three.badge"))}</div><div class="font-extrabold title-gradient" data-v-2a776d99${_scopeId}>${ssrInterpolate(unref(t)("explore.timelinePage.practice.three.title"))}</div><p class="text-sm text-muted" data-v-2a776d99${_scopeId}>${ssrInterpolate(unref(t)("explore.timelinePage.practice.three.desc"))}</p></div></div>`);
          } else {
            return [
      ...
      _push(`</div></div></div><div class="card card-hover card-accent accent-leopard overflow-hidden js-reveal" data-v-2a776d99><div class="card-body flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4" data-v-2a776d99><div class="space-y-1" data-v-2a776d99><div class="badge badge-accent w-fit" data-v-2a776d99>`);
      _push(ssrRenderComponent(_component_Icon, {
        name: "mdi:shield-lock-outline",
        "aria-hidden": "true"
      }, null, _parent));
      _push(` ${ssrInterpolate(unref(t)("explore.timelinePage.bottom.badge"))}</div><div class="font-extrabold text-lg title-gradient" data-v-2a776d99>${ssrInterpolate(unref(t)("explore.timelinePage.bottom.title"))}</div><p class="text-sm text-muted" data-v-2a776d99>${ssrInterpolate(unref(t)("explore.timelinePage.bottom.desc"))}</p></div><div class="flex flex-wrap gap-2" data-v-2a776d99>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/timeline/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-2a776d99"]]);

export { index as default };
//# sourceMappingURL=index-n3gKwu8P.mjs.map
